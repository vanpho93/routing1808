...
var config = [
    ...
    { path: 'detail/:id', component: __WEBPACK_IMPORTED_MODULE_4__detail_detail_component__["a" /* DetailComponent */] },
...
AppRoutingModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["M" /* NgModule */])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* RouterModule */].forRoot(config)
        ],
        declarations: [
...
var ContactService = (function () {
    ...
    ContactService.prototype.getContactById = function (id) {
        var contact = contacts.find(function (e) { return e.id === id; });
...
module.exports = "<p>Name: {{ contact?.name }}</p>\n"
...
var DetailComponent = (function () {
    function DetailComponent(route, contactService) {
        this.route = route;
        this.contactService = contactService;
        this.contact = null;
    }
    DetailComponent.prototype.ngOnInit = function () {
        ...
        this.route.paramMap.subscribe(function (params) {
            ...
            _this.contactService.getContactById(id)
...
DetailComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__contact_service__["a" /* ContactService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__contact_service__["a" /* ContactService */]) === "function" && _b || Object])
], DetailComponent);
